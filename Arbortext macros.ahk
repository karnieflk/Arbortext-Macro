...
; Creates Menu for gui screen
    ...
    ;~ Creates menu for R+L mouse button
...
~MButton::
{
   ...
   IF Middle_Click_Active = 1
   {
      ...
      If Win_Class = %Windchill_Class%
            If Win_title contains Google Chrome
                  Send {Shift Down}
               Sleep 400
               Send {Shift Up}
}
...
RButton::RButton ; This need to be there to allow the right click to work correctly due to the Rbutton + Lbutton hotkey below.
...
Sleep 100
WinWaitActive, PTC Arbortext Editor Message
Sleep 100
Send {Enter}
Sleep 300
   }
...
SEnd {Alt down}{k}{Alt up}
      ...
      Send {tab 8}
      Sleep 500
      If Select_COntrol_Number = 1
      Send {c}{o}{n}{t}{r}{o}{l} {Space}{n}{u}{m}{b}{e}{r}{tab}{Enter}
      else
   ...
   CavnasSucceed:
   {
      IfWinExist, %Canvas_Succeeded_Window_Title% ahk_class %Windchill_Class% ; checks to see if the ACM Save2WC Function Succeeded window exists
      {
         ...
         */
         ...
         {
            global Search_Window_Title, Windchill_Class, Arbortext_Window_Title
            Search_text =
           ...
           Loop
         {
            ...
            Sleep 300
               ...
               Sleep 500 ; delays program for 400 milliseconds
